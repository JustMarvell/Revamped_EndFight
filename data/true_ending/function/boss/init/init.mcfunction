...
# Extended phases init
scoreboard players set @s trueEnding_bigphase 1
scoreboard players set @s trueEnding_attacktimer 0
scoreboard players set @s trueEnding_attacktimer2 0
scoreboard players set @s trueEnding_p2_transitioning 0
scoreboard players reset trueEnding_wave trueEnding_storage
