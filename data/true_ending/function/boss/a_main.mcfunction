...
#=================================================
# BIG PHASE ROUTING
# Initialize bigphase to 1 on first tick
# bigphase initialized in init.mcfunction

# Phase 3: dragon is away, run mob wave loop instead of normal AI
execute if score @s trueEnding_bigphase matches 3 run function true_ending:phases/p3_main
execute if score @s trueEnding_bigphase matches 3 run return 0

# Phase 4: final chaos phase
execute if score @s trueEnding_bigphase matches 4 run function true_ending:phases/p4_main

# Phase 2: transition animation lock
execute if score @s trueEnding_bigphase matches 2 if score @s trueEnding_p2_transitioning matches 1 run function true_ending:phases/p2_transition_anim
execute if score @s trueEnding_bigphase matches 2 if score @s trueEnding_p2_transitioning matches 1 run return 0

# Phase 2: extra attack timer (runs alongside normal P1 attacks)
execute if score @s trueEnding_bigphase matches 2 run function true_ending:phases/p2_main
#=================================================
