...
# Extended phases scoreboards
scoreboard objectives add trueEnding_bigphase dummy
scoreboard objectives add trueEnding_attacktimer dummy
scoreboard objectives add trueEnding_attacktimer2 dummy
scoreboard objectives add trueEnding_attackroll dummy
scoreboard objectives add trueEnding_p2_transitioning dummy

# Restore exitportal marker if the portal exists in the world but the marker is missing
execute in the_end positioned 0 100 0 unless entity @e[type=marker,tag=trueEnding_exitportal] run function true_ending:ambience/exitportal_summon