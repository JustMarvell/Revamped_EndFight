...
title @a[distance=..256] title {"text":"...I see.","color":"gray","bold":true}
title @a[distance=..256] subtitle {"text":"So this is how a dragon falls. Remember this, mortal.","color":"dark_gray","italic":true}
title @a[distance=..256] actionbar {"text":"✦ The Ender Dragon has been slain ✦","color":"gold","italic":true}
